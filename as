...
local SaveFileName = "AlSploitBedwarsModuleSaving"
...
task.spawn(function()
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateSlider(CombatTab, "Range", Settings.KillAura.Range, 18, LayoutOrder + 4, function(CallBack)
