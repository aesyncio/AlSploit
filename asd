...
Open.Size = UDim2.new(0.049, 0, 0.084, 0)
...
local TextLabelAlSploit = Instance.new("TextLabel")
...
TextLabelAlSploit.Parent = AlSploit
TextLabelAlSploit.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextLabelAlSploit.BackgroundTransparency = 1.000
TextLabelAlSploit.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextLabelAlSploit.BorderSizePixel = 0
TextLabelAlSploit.Position = UDim2.new(0.5, 0, 0, 0)
TextLabelAlSploit.Size = UDim2.new(0, 200, 0, 50)
TextLabelAlSploit.Font = Enum.Font.FredokaOne
TextLabelAlSploit.Text = "AlSploit"
TextLabelAlSploit.Name = "AlSploitWatermark"
TextLabelAlSploit.ZIndex = 0
TextLabelAlSploit.TextColor3 = Color3.fromRGB(255, 255, 255)
TextLabelAlSploit.TextScaled = true
TextLabelAlSploit.TextSize = 14.000
TextLabelAlSploit.TextStrokeColor3 = Color3.fromRGB(28, 28, 28)
TextLabelAlSploit.TextWrapped = true
TextLabelAlSploit.TextStrokeTransparency = 1
...
task.spawn(function()
	while task.wait(0.01) and AlSploit:FindFirstChild("AlSploitWatermark") do
...
task.spawn(function()
	...
	while task.wait(0.5) do
		...
		if Settings.Cape.Value == true and Cooldown == false and IsAlive(LocalPlayer) then
			...
			task.spawn(function()
				while task.wait(0.001) and IsAlive(LocalPlayer) do
					if IsMoving() then
