...
task.spawn(function()
	RunService.Heartbeat:Connect(function(Delta)
		if Settings.Speed.Value == true and IsAlive(LocalPlayer) then			
			...
			local Raycast = game.Workspace:Raycast(LocalPlayer.Character.PrimaryPart.Position, SpeedCFrame, SpeedRaycastParameters)
