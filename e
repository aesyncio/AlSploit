...
local SaveFileName = "AlSploitPublicUpdate14"
			...
			task.spawn(function()
				...
				repeat
					...
					if IsAlive(LocalPlayer) and Settings.Scaffold.Value == true then
						for i = 1, 2 do
							local ScaffoldCFrame = LocalPlayer.Character.HumanoidRootPart.Position + ((LocalPlayer.Character.Humanoid.MoveDirection) * (i * 3.3)) + Vector3.new(0, -math.floor((LocalPlayer.Character.HumanoidRootPart.Size / 2) + (LocalPlayer.Character.Humanoid.HipHeight + 1.5), 0)
