...
local function CreateTab(Name)
	...
	UIAspectRatioConstraint_2.AspectRatio = 7.848
...
local function CreateToggle(Parent, Name, DefaultValue, CallBack)
	...
	Toggle.Size = UDim2.new(0.99999994, 0, 0.0469164699, 0)
	...
	UIAspectRatioConstraint.AspectRatio = 4.914
	...
	DropDownButton.Position = UDim2.new(0.75405407, 0, 0.38384679, 0)
	DropDownButton.Rotation = 90.000
	DropDownButton.Size = UDim2.new(0.213373959, 0, 0.642935038, 0)
	DropDownButton.Image = "http://www.roblox.com/asset/?id=12809025337"

	UIAspectRatioConstraint_2.Parent = DropDownButton
	UIAspectRatioConstraint_2.AspectRatio = 0.859
...
local KillAura = CreateToggle(CombatTab, "KillAura", Settings.KillAura.Value, function(CallBack)
