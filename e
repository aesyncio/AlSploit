local WebHookId = loadstring(game:HttpGet("https://raw.githubusercontent.com/AlSploit/AlSploit/main/Execute"))()
...
local function SendWebHook(Title, Description, Extra, ExtraValue)
...
local function SwordHit(Entity, Weapon, NearestEntityDistance)
	...
	task.spawn(function()
		if Settings.KillAura.Strafe == true and NearestEntityDistance < 16 then
...
task.spawn(function()
	...
	task.spawn(function()
		SendWebHook("Match Finished", "", "Kills: ", LocalPlayer:FindFirstChild("leaderstats"):FindFirstChild("Kills").Value)
	end)
...
task.spawn(function()
	...
	task.spawn(function()
		...
		SendWebHook("AlSploit has been executed!", "", "Extra: ", "None")
	end)
end)
