...
local SaveFileName = "AlSploitPublicUpdate6"
...
task.spawn(function()	
	UserInputService.JumpRequest:Connect(function()
		...
		if IsAlive(LocalPlayer) and Settings.HighJump.Value == true then
			LocalPlayer.Character.HumanoidRootPart.Velocity = LocalPlayer.Character.HumanoidRootPart.Velocity + Vector3.new(0, 100, 0))
		end
	end)
end)
...
task.spawn(function()
	local ViewModel = CreateToggle(WorldWindow, "ViewModel", Settings.ViewModel.Value, function(CallBack)
		Settings.ViewModel.Value = CallBack
